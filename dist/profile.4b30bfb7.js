...
})({"fYljT":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "fc97a6884b30bfb7";
...
},{}],"f3pcf":[function(require,module,exports) {
...
function renderOrder(item1) {
    ...
    <div class="order__info">
        ...
        <p class="order__id"><strong>ID: </strong> ${item1.id}</p>
        <p class="order__total"><strong>Total: </strong> ${"$" + item1.total} </p>
        ${userLogged && userLogged.isAdmin ? userInfo : ""}
    </div>

    <section class="order__products" id="order__products__${item1.id}">
...
},{"./app":"dVfCV","firebase/firestore":"cJafS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fYljT","f3pcf"], "f3pcf", "parcelRequire0c07")

//# sourceMappingURL=profile.4b30bfb7.js.map

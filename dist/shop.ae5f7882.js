...
})({"gihjZ":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
createUserForm.addEventListener("submit", async (e)=>{
    ...
    const newUser = await createUser(_app.auth, userInfo);
    await addUserToDatabase(_app.db, newUser.uid, userInfo);
...
loginForm.addEventListener("submit", (e)=>{
    ...
    login(_app.auth, email, password);
});
...
},{"./app":"dVfCV","firebase/auth":"drt1f","firebase/firestore":"cJafS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gihjZ","gEzfo"], "gEzfo", "parcelRequire0c07")

//# sourceMappingURL=shop.ae5f7882.js.map
